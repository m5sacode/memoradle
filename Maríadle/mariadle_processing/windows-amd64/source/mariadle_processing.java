/* autogenerated by Processing revision 1290 on 2024-08-14 */
...
public class mariadle_processing extends PApplet {
...
int chosenindex = PApplet.parseInt(random(palabras.length));
...
public void DRAWLETTER(char letter, int fill, float x, float y) {
  strokeWeight(2);
  if (fill == 0) {
   stroke(240);
   noFill();
...
public void DRAWBOARD(char[] letters, int[] types, int columns,int x0,int y0){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "mariadle_processing" };
    if (passedArgs != null) {
